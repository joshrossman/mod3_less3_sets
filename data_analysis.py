...
# Objective: The aim of this assignment is to enhance your skills in 
# using Python sets for data analysis tasks. You will apply various set operations 
...
# Example Code:customer_ids = ["C001", "C002", "C003", "C002", "C001", "C004"]
